...
:za-lb-null-handler() { :; }
@zinit-register-annex "z-a-linkbin" hook:atclone-50 :za-lb-atclone-handler :za-lb-null-handler "lbin|lbin''"
@zinit-register-annex "z-a-linkbin" hook:\%atpull-50 :za-lb-atclone-handler :za-lb-null-handler
@zinit-register-annex "z-a-linkbin" hook:atdelete-50 :za-lb-atdelete-handler :za-lb-null-handler
